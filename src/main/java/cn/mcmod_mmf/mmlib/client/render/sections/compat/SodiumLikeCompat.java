...
import cn.mcmod_mmf.mmlib.client.render.sections.events.SectionGeometryRenderTypeEvents;
...
public final class SodiumLikeCompat {
    ...
    public static RenderType createCutoutRenderType(ResourceLocation textureResourceLocation) {
        if (isInstalled()) {
            return RenderType.create("section_sodium_like_dummy_cutout", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.QUADS, 1536, true, false, RenderType.CompositeState.builder()
    ...
    public static RenderType createTranslucentRenderType(ResourceLocation textureResourceLocation) {
        if (isInstalled()) {
            return RenderType.create("section_sodium_like_dummy_translucent", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.QUADS, 1536, true, true, RenderType.CompositeState.builder()
