...
public class FoodInfo {
    ...
    public FoodInfo(String name, int amount, float calories, boolean iswolffood, float water, float grain, float fruit,
            float veg, float meat, float dairy, float decayModifier, float heatCapacity, float cookingTemp) {
        this(name, amount, calories, iswolffood, false, 32, water, grain, fruit, veg, meat, dairy, decayModifier,
                heatCapacity, cookingTemp);
    }

    public FoodInfo(String name, int amount, float calories, boolean iswolffood, boolean isalways, int time,
            float water, float grain, float fruit, float veg, float meat, float dairy, float decayModifier,
            float heatCapacity, float cookingTemp) {
        this.name = name;
        this.amount = amount;
